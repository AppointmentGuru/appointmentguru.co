<template>
  <v-container class="page-container">
    ...
    <v-layout row wrap>
      ...
      <v-flex xs12 sm6>
        <iframe :class="iframeClasses" v-if="selectedPractitioner" :src="iframeSrc"></iframe>
      </v-flex>
    </v-layout>
  </v-container>
</template>
  ...
  i18n: {
    messages: {
      en: {
        title: "Book a demo",
        description:
          "We are available to take you through AppointmentGuru and how it can work for you. Demo's are one-on-one sessions and are available either online or in person (depending on where you are)",
        list: {
          title:
            "Make an appointment with an AppointmentGuru consultants today!",
        },
      },
    },
  },

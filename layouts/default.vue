        ...
        <v-flex sm7 xs12 >
          <v-layout class='mt-3' row wrap >
            ...
            <v-flex xs6 sm4 class='text-sm-right pa-3' >
              ...
              <ul class="list-unstyled list-spaced mt-3">
              <li class="text-muted"><a href="https://help.appointmentguru.co" target="_blank" title="AppointmentGuru help and customer support knowledgebase. Courses, help articles, videos, frequently asked questions and more" >Help</a></li>
